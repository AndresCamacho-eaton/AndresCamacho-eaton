<div align="center">
    ...
    <div style="display:grid;grid-template-columns: repeat(2, minmax(0, 1fr));gap: 1rem;align-items:center">
        <h3 align="left">
            Hi 👋! My name is Javier and I'm a FullStack Developer from Mexico , working mainly backend using NestJS,
            Docker, Postgres, Reactjs and give maintenance to bid manager
        </h3>
        <img src="https://camo.githubusercontent.com/9738fd9661e1dc489d6018b1663609c715aa0c3bff1eb8f58a35962d8f6725d5/68747470733a2f2f6d656469612e74656e6f722e636f6d2f79324a586b593170586b77414141414d2f6361742d636f6d70757465722e676966" width="200" style="justify-self:center;border:ronuded">
    </div>
    <hr>
    <h3 id="languages-and-tools">Languages and Tools</h3>
      <p>
        ...
        <img src="https://badgen.net/badge/Bootstrap/CSS/563D7C?icon=bootstrap" height="25" alt="Bootstrap">
        <img src="https://badgen.net/badge/TailwindCSS/framework/38BDF8?icon=tailwindcss" height="25" alt="Tailwind CSS">
        <img src="https://badgen.net/badge/Nestjs/framework/F54927?icon=Nestjs" height="25" alt="Nestjs">
        <img src="https://badgen.net/badge/React/framework/38BDF8?icon=React" height="25" alt="React">
        <img src="https://badgen.net/badge/Vue.js/framework/43853D?icon=Vue.js" height="25" alt="Vue.js">
        <img src="https://badgen.net/badge/Laravel/framework/E34F26?icon=Laravel" height="25" alt="Laravel">
        <img src="https://badgen.net/badge/MongoDB/database/4EA94B?icon=mongodb" height="25" alt="MongoDB">
        <img src="https://badgen.net/badge/MySQL/database/0000FF?icon=mysql" height="25" alt="MySQL">
        <img src="https://badgen.net/badge/MariaDB/database/324D8A?icon=MariaDB" height="25" alt="MySQL">
        ...
        <img src="https://badgen.net/badge/Manjaro/Linux/2A826A?icon=Manjaro" height="25" alt="Ubuntu">    
        <img src="https://badgen.net/badge/VirtualBox/VM/2A826A?icon=VirtualBox" height="25" alt="VirtualBox">    
        <img src="https://badgen.net/badge/KVM/VM/2A826A?icon=KVM" height="25" alt="KVM">    
    </p>
    <hr>
        <h3 style="display:flex;justify-content:center;gap:1vh">
        ...
        <p>
            <img 
                src="https://github-readme-streak-stats.herokuapp.com/?user=BrydeRov&amp;theme=radical&amp;include_all_commits=true&amp;count_private=true" 
                alt="BrydeRov github streak"
            >
        </p>
    <hr>
</div>
